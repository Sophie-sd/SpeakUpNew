        ...
        ACHIEVEMENTS_DATA = [
            {
                'number': 200000,
                'suffix': '+',
                'label_uk': 'Українців вже підвищили рівень з нами',
                'label_ru': 'Украинцев уже повысили уровень с нами',
                'order': 1,
                'is_active': True
            },
            {
            ...
            },
            {
                'number': 5000,
                'suffix': '+',
                'label_uk': 'Студентів навчається в Україні зараз',
                'label_ru': 'Студентов обучается в Украине сейчас',
                'order': 4,
                'is_active': True
            },
            {
                'number': 100,
                'suffix': '+',
                'label_uk': 'шкіл в 11 країнах на 4 континентах',
                'label_ru': 'школ в 11 странах на 4 континентах',
                'order': 5,
                'is_active': True
            },
            {
