...
function initLevelCardsNavigation() {
  ...
  containers.forEach((container) => {
    ...
    const navWrapper = wrapper.querySelector('.level-cards-nav-wrapper');
    if (!navWrapper) return;

    const prevBtn = navWrapper.querySelector('.level-cards-nav--prev');
    const nextBtn = navWrapper.querySelector('.level-cards-nav--next');
...
export { initLevelCardsNavigation };
